...
class Util {
  ...
  static hashAndSerializeAlias(alias) {
    ...
    return bs58.encode(sha256(buffer.Buffer.from(stringify(alias), 'utf8')));
  }
  /**
   * Hash a string value.
   *
  ...
  static hashString(value) {
    return bs58.encode(sha256(buffer.Buffer.from(value, 'utf8')));
  }
  /**
  ...
  static wrapBuffer(buffer$1) {
    return new Uint8Array(buffer.Buffer.from(buffer$1));
  }
  /**
...
exports.TokenClient = TokenClient$1;
